...
class SignInPage : AppCompatActivity() {
    ...
    companion object {
        const val KEY1 = "com.example.contactmanagerapp.mail"
        const val KEY2 = "com.example.contactmanagerapp.name"
        const val KEY3 = "com.example.contactmanagerapp.username"
    }
    ...
    private fun readData(userName: String) {
        ...
        databaseReference.child(userName).get().addOnSuccessListener {
            ...
            if (it.exists()) {
                ...
                val intentWelcome = Intent(this, ContactsMainScreen::class.java)
